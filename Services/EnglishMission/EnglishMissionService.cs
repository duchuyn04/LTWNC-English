...
public sealed class EnglishMissionService : IEnglishMissionService
{
    ...
    {
        return "You are an English conversation tutor. Return exactly one valid JSON object with no markdown or extra text. Use this shape: {\"npcReply\":\"Can you describe your bag?\",\"suggestedReplyEn\":\"It is black.\",\"suggestedReplyVi\":\"Nó màu đen.\",\"feedbackVi\":\"Tốt.\",\"correctionEn\":null,\"correctionExplanationVi\":null,\"usedTargetWords\":[],\"achievedGoalIds\":[],\"missionCompleted\":false}. npcReply and suggestedReplyEn must be simple CEFR A1-A2 English. npcReply must be one or two short sentences with at most one simple question and 20 words maximum. suggestedReplyEn must be exactly one simple sentence with 12 words maximum. suggestedReplyVi, feedbackVi and correctionExplanationVi must be short natural Vietnamese. Use only target words and goal IDs from the user message. Do not add fields.";
    }
